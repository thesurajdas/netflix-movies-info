            ...
            <div className={styles.container}>
                <div className={styles.grid_two_section}>
                    <div className={heroStyles.hero_content}>
                        <h1>{title}</h1>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus, molestiae tenetur. Harum dolor distinctio saepe?</p>
                        <Link href="/movies">
                            <button>Explore Movies</button>
                        </Link>
                    </div>
                    <div className={heroStyles.hero_image}>
                        <Image src={imgUrl} alt="Home Page logo" width={500} height={500}></Image>
                    </div>
                </div>
            </div>
            <div className={styles['custom-shape-divider-bottom-1690313055']}>
